...
#if defined(SERVO)
void initializeServo();//サーボモーターを初期化する処理
#endif

/**************************************************************************************/
/***************                  Motor Pin order                  ********************///モーターピン呼び出し
/**************************************************************************************/
...
//
#if defined(PROMINI)
  uint8_t PWM_PIN[8] = {9,10,11,3,6,5,A2,12};   //for a quad+: rear,right,left,front 後方、右、左、前方の値を指す。引数の値によってモーターの値が違う。
#endif
#if defined(PROMICRO)
  #if !defined(HWPWM6)
    #if defined(TEENSY20)
